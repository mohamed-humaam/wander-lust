...
@section('content')
        ...
        <div class="container mx-auto pt-32 sm:pt-24 pb-20 sm:pb-6 px-4 relative z-20 h-full flex flex-col justify-center">
            <div
                ...
                <p class="text-lg sm:text-xl text-white mb-4 md:mb-8">Explore our curated collection of luxury
                    accommodations in breathtaking locations worldwide.</p>
    ...
    <div class="bg-gray-50 dark:bg-gray-900 py-8 sm:py-12">
        <div class="container mx-auto px-4">
            <div class="text-center mb-8 sm:mb-12">
                ...
                <p class="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Find the perfect stay that matches your
                    travel style</p>
            </div>
    ...
    <div class="bg-gray-50 dark:bg-gray-900 py-10 sm:py-16">
        <div class="container mx-auto px-4">
            <div class="text-center mb-8 sm:mb-12">
                ...
                <p class="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Don't just take our word for it - hear
                    from our satisfied guests</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                <div class="bg-white dark:bg-gray-800 p-5 sm:p-6 rounded-lg shadow-sm">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm sm:text-base">"The villa was absolutely stunning
                        with breathtaking views. The service was impeccable and we'll definitely be back!"</p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-5 sm:p-6 rounded-lg shadow-sm">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm sm:text-base">"Perfect location and the room was
                        even better than the photos. The staff went above and beyond to make our stay special."</p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-5 sm:p-6 rounded-lg shadow-sm">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 text-sm sm:text-base">"From booking to checkout,
                        everything was seamless. The property was clean, modern, and had all the amenities we
                        needed."</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 py-10 sm:py-16">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto">Sign up for exclusive deals and early access to our
                newest properties</p>
