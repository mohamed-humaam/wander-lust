    ...
    <div class="relative h-[70vh] min-h-[500px] overflow-hidden">
        ...
        <div class="container mx-auto pt-44 sm:pt-24 pb-20 sm:pb-6 px-4 relative z-20 h-full flex flex-col justify-end">
            <div
                ...
                <p class="text-lg text-white/90 mb-6 max-w-2xl">Discover our curated collection of
                    premium {{ strtolower($category->name) }} accommodations in breathtaking locations worldwide.</p>
        ...
        <div class="container mx-auto px-4 sm:px-6">
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12">
                <div class="mb-6 lg:mb-0">
                    <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">
                        Our {{ $category->name }} Collection</h2>
                    <p class="text-gray-600 dark:text-gray-400">{{ $locations->total() }} carefully selected
                        properties</p>
                </div>
            ...
            @if($locations->isEmpty())
                <div class="text-center py-16">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 max-w-md mx-auto">We're currently updating our
                        collection. Please check back soon for amazing {{ strtolower($category->name) }} options.</p>
