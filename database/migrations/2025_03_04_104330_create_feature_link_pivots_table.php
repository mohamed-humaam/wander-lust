...
return new class extends Migration
{
    ...
    {
        Schema::create('feature_link_pivots', function (Blueprint $table) {
            $table->id();
            $table->foreignUlid('feature_id')->references('id')->on('features')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('feature_link_pivots');
    }
};
