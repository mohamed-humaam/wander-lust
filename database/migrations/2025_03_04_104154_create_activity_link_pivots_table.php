...
return new class extends Migration
{
    ...
    {
        Schema::create('activity_link_pivots', function (Blueprint $table) {
            $table->id();
            $table->foreignUlid('activity_id')->references('id')->on('activities')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('activity_link_pivots');
    }
};
